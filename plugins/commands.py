...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                  ...
                  InlineKeyboardButton('💌 𝐁𝐮𝐲 𝐓𝐨 𝐁𝐨𝐭 💌', callback_data='source')
                ],[
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('🦋 𝐓𝐚𝐦𝐢𝐥𝐑𝐨𝐜𝐤𝐞𝐫𝐳 𝐓𝐑 🦋', url="https://t.me/TamilRockerz_TR") #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/Kalitgadmin_Bot")
                         ],[ 
                            InlineKeyboardButton('🦋 𝐓𝐚𝐦𝐢𝐥𝐑𝐨𝐜𝐤𝐞𝐫𝐳 𝐓𝐑 🦋', url="https://t.me/TamilRockerz_TR") #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
